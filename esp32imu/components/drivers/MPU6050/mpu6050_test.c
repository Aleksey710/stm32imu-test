...
#include "webserver.h"
//----------------------------------------------------------------------
#define CONFIG_EXAMPLE_SDA_GPIO I2C_SDA
#define CONFIG_EXAMPLE_SCL_GPIO I2C_SCL

#define CONFIG_EXAMPLE_I2C_ADDRESS_LOW

#ifdef CONFIG_EXAMPLE_I2C_ADDRESS_LOW
#define ADDR MPU6050_I2C_ADDRESS_LOW // 0x68
#else
#define ADDR MPU6050_I2C_ADDRESS_HIGH // 0x69
#endif
